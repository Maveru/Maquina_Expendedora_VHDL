...
begin
 ...
 nextstate_decod: process (Botones, current_state,CLK) 
 begin
...
elsif    (current_state = S0 OR current_state = S1 OR current_state = S2   OR current_state = S3) then   -- significa que aun estamos seleccionando bebida
